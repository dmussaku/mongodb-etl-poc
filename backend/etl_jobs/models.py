...
class Pipeline(models.Model):
    ...
    # Load Configuration
    load_type = models.CharField(max_length=50, choices=LOAD_TYPE_CHOICES, default='full')
    incremental_strategy = models.CharField(max_length=50, choices=INCREMENTAL_STRATEGY_CHOICES, blank=True, null=True)
    ...
    masking_config = models.JSONField(default=dict, blank=True, help_text="Masking rules as key-value pairs")
    
    # Scheduling
    frequency = models.CharField(max_length=255, blank=True, null=True, help_text="Cron expression (e.g., '0 2 * * *')")
...
class JobExecution(models.Model):
    ...
    duration_seconds = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True)
